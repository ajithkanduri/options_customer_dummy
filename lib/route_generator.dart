import 'package:options_consumer_app/src/screens/categories.dart';
import 'package:options_consumer_app/src/screens/tabs.dart';
import 'package:options_consumer_app/src/screens/product.dart';
import 'package:options_consumer_app/src/screens/on_boarding.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/Categories': return MaterialPageRoute(builder: (_) => CategoriesWidget(dataSnapShot:args));
      // case '/Orders':
