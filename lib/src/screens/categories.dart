...
import 'package:options_consumer_app/src/models/route_argument.dart';
...
class _CategoriesWidgetState extends State<CategoriesWidget> {
  ...
  List<Category> _list;
  void initState() {
    _list = _categoriesList.getCategories(widget.dataSnapShot);
    super.initState();
  }
          ...
          children: <Widget>[
            ...
            Wrap(
              ...
              children: List.generate(_list.length, (index) {
                Category category = _list.elementAt(index);
...
//        child: buildOddCategory(context),
  ...
  Widget buildEvenCategory(BuildContext context, Category category) {
    return Row(
      ...
      children: <Widget>[
        FutureBuilder(
            future: DataStore().getSubcategory(category),
            builder: (context,AsyncSnapshot<List<QueryDocumentSnapshot>> subsnap){
                if(subsnap.hasData){
                  print(subsnap.data);
                  return Row(
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Wrap(
                            ...
                            spacing: 10,
                            runSpacing: 5,
                            children: List.generate(subsnap.data.length, (index) {
                              SubCategory subCategory = SubCategory.fromSnapShot(subsnap.data.elementAt(index));
                              return Material(
