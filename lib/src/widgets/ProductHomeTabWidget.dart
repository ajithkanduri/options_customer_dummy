...
import 'package:options_consumer_app/src/models/product_color.dart';
import 'package:options_consumer_app/src/models/product_size.dart';
import 'package:options_consumer_app/src/widgets/FlashSalesCarouselWidget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              SizedBox(width: 10),
              Text(
                widget.product.isDiscountedProduct?widget.product.price.toStringAsFixed(2):"",
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10),
              SelectColorWidget(product: widget.product)
            ],
          ),
        ),
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10),
              SelectSizeWidget(product: widget.product)
            ],
          ),
        ),
        Padding(
        ...
        //     heroTag: 'product_related_products', productsList: widget.product.relatedProducts),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: List.generate(widget.product.colors.length, (index) {
        var _color = widget.product.colors.elementAt(index);
        return buildColor(_color);
      }),
    );
  }

  SizedBox buildColor(Colour   color) {
    return SizedBox(
      width: 38,
      height: 38,
      child: FilterChip(
        ...
        backgroundColor: HexColor(color.hexCode),
        selectedColor: HexColor(color.hexCode),
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: List.generate(widget.product.size.length, (index) {
        var _size = widget.product.size.elementAt(index);
        return buildSize(_size);
      }),
    );
  }

  SizedBox buildSize(String size) {
    return SizedBox(
      height: 38,
      child: RawChip(
        label: Text(size),
